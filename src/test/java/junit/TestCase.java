...
public class TestCase {
    ...
    public void passEncodingTest(){
        ...
        assertEquals("62B4750DF747D46941BA9136ED86DBC9",encoder.getMD5EncodedPassword("ioanna"));
    }

    @Test
    public void getUserRoleByLoginTest(){
        UserIdentificationHelper helper = new UserIdentificationHelper();
        assertEquals("admin",helper.getRoleByLogin("admin"));
    }

    @Test
    public void isUserExistTest(){
        UserIdentificationHelper helper = new UserIdentificationHelper();
        assertTrue(helper.isUserExist("admin"));
    }

    @Test
    public void isUserValidTest(){
        UserIdentificationHelper helper = new UserIdentificationHelper();
        assertTrue(helper.isUserValid("admin","admin"));
    }

    @Test
    public void lettersDigitsRegExpTest(){
        RegExp regExp = new RegExp();
        assertTrue(regExp.isValidInput(RegExp.LETTERS_DIGITS_REGEXP,"ЇїжакіІєЄ123"));
    }

    @Test
    public void vendorCodeRegExpTest(){
        RegExp regExp = new RegExp();
        assertTrue(regExp.isValidInput(RegExp.VENDOR_CODE_REGEXP,"123456789"));
    }
    ...
    public void calculateCheckSumTest(){
        ...
        assertEquals(150,checkService.calculateCheckSum(check));
    }
    ...
    public void addProductToCheckTest(){
        ...
        assertEquals(2,check.getProducts().size());
    }
